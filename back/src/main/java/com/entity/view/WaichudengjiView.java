...
public class WaichudengjiView extends WaichudengjiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 外出类型的值
		*/
		private String waichudengjiValue;
	...
	public WaichudengjiView(WaichudengjiEntity waichudengjiEntity) {
		try {
			...
			* 获取： 外出类型的值
			*/
			public String getWaichudengjiValue() {
				return waichudengjiValue;
			}
			/**
			* 设置： 外出类型的值
			*/
			public void setWaichudengjiValue(String waichudengjiValue) {
				this.waichudengjiValue = waichudengjiValue;
			}
