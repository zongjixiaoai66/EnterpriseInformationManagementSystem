    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="打卡类型" prop="dakaTypes">
                        <el-select v-model="ruleForm.dakaTypes" :disabled="ro.dakaTypes" placeholder="请选择打卡类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="打卡类型" prop="dakaValue">
                        <el-input v-model="ruleForm.dakaValue"
                            placeholder="打卡类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="!(sessionTable=='yuangong' &&type!='info')">
                    <el-form-item class="select" v-if="type!='info'"  label="打卡状态" prop="dakaZhuangtaiTypes">
                        <el-select v-model="ruleForm.dakaZhuangtaiTypes" :disabled="ro.dakaZhuangtaiTypes" placeholder="请选择打卡状态">
                            <el-option
                                v-for="(item,index) in dakaZhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="打卡状态" prop="dakaZhuangtaiValue">
                        <el-input v-model="ruleForm.dakaZhuangtaiValue"
                            placeholder="打卡状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="!(sessionTable=='yuangong' &&type!='info')">
                    <el-form-item v-if="type!='info'"  class="input" label="打卡时间" prop="dakaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.dakaTime"
                                type="datetime"
                                placeholder="打卡时间"
                                :disabled="ro.dakaTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.dakaTime" label="打卡时间" prop="dakaTime">
                            <span v-html="ruleForm.dakaTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=daka_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.dakaZhuangtaiTypesOptions = data.data.list;
                    }
                });
